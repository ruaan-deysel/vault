...
func TestRestoreSinglePointDedupRouteToChunkedMissingJob(t *testing.T) {
	...
	err := r.restoreSinglePoint(context.Background(), rp, "plex", "container", "", "", nil, false, restoreProgressReporter{})
	if err == nil {
...
func TestRestoreSinglePointClassicEmpty(t *testing.T) {
	...
	err := r.restoreSinglePoint(context.Background(), rp, "no-such-item", "totally-unknown-type",
		"", "", nil, false, restoreProgressReporter{})
	if err == nil {
...
func TestRestoreSinglePointDedupChunkedBadHandlerType(t *testing.T) {
	...
	err := r.restoreSinglePoint(context.Background(), rp, "x", "bogus-type", "", "", nil, false, restoreProgressReporter{})
	if err == nil {
