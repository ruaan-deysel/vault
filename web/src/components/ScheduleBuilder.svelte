...
<div class="space-y-4">
  ...
  <div class="flex items-center gap-2 px-3 py-2 bg-vault/5 border border-vault/20 rounded-lg">
    <svg class="w-4 h-4 text-vault shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
