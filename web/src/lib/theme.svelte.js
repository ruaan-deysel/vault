...
function applyTheme() {
  ...
  // Retro fonts (Press Start 2P / VT323) are self-hosted @font-face rules in
  // app.css. The browser fetches them only when a retro style's CSS actually
  // selects the family, so there is nothing to load or unload here.
}
