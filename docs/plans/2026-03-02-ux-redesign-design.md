...
1. Onboarding wizard + welcome screen
2. Dashboard health score
3. Dashboard activity timeline
4. Jobs inline editing + enriched cards
5. Settings tabbed restructure

### Phase 3: Advanced Features

1. Restore wizard redesign
2. History timeline view + filtering + chart
3. Storage improvements (usage bar, health)
4. Logs improvements
5. Global search / command palette
6. Job bulk operations
7. Quick restore from Dashboard

### Phase 4: Polish

1. Mobile bottom nav + pull-to-refresh
2. Theme toggle in sidebar
3. Log export
4. Job duplication
